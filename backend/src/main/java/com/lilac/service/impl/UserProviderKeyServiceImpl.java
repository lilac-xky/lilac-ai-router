...
public class UserProviderKeyServiceImpl extends ServiceImpl<UserProviderKeyMapper, UserProviderKey> implements UserProviderKeyService {
    ...
    public boolean addUserProviderKey(UserProviderKeyAddRequest request, Long userId) {
        ...
        if (provider == null) {
            throw new BusinessException(HttpsCodeEnum.PARAMS_ERROR, "提供者不存在");
        }
        ...
        if (existing != null) {
            throw new BusinessException(HttpsCodeEnum.PARAMS_ERROR, "已配置过该提供者的密钥，请使用更新功能");
        }
