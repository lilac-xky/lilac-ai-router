<template>
    <div id="myKeysPage">
            ...
            <a-table :columns="columns" :data-source="keys" :loading="loading" :pagination="false" row-key="id">
                ...
                <template #action="{ record }">
                    <a-space>
                        ...
                        <a-popconfirm title="确定要删除这个密钥吗？" @confirm="handleDelete(record.id)">
        ...
        <!-- 添加密钥弹窗 -->
        <a-modal v-model:open="addModalVisible" title="添加 API Key" @ok="handleAdd" @cancel="addModalVisible = false"
            width="600px">
            <a-form :model="addForm" layout="vertical">
                ...
                <a-form-item label="API Key" required>
                    <a-input-password v-model:value="addForm.apiKey" placeholder="请输入您自己的 API Key" :maxlength="512" />
                    <div class="form-hint">
        ...
        <!-- 编辑密钥弹窗 -->
        <a-modal v-model:open="editModalVisible" title="更新 API Key" @ok="handleUpdate"
            @cancel="editModalVisible = false" width="600px">
            <a-form :model="editForm" layout="vertical">
                ...
                <a-form-item label="新的 API Key">
                    <a-input-password v-model:value="editForm.apiKey" placeholder="请输入新的 API Key（留空表示不修改）"
                        :maxlength="512" />
                </a-form-item>
